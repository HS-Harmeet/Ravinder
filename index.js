...
export default {
  ...
  cityData(cityname, apikey){
      console.log('first api call',http);
      return Method.POST(`weather?q=${cityname}&appid=${apikey}`,null)
  },

  allWeatherData(lat,lon,exclude,apiKey){
      console.log('all data lat,lon,exclude,apiKey',lat,lon,exclude,apiKey);
      return Method.POST(`onecall?lat=${lat}&lon=${lon}&exclude=${exclude}&appid=${apiKey}`,null)
  }
